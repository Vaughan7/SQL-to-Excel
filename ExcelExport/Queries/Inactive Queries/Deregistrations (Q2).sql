select  DSH_SERIAL_NO,
        ...
        APPL_DT,
        NVL (APL_DECISION_CD, 'PEN') APL_DECISION_CD,
        apl_last_sta_cd,
        DATE_SUBMITTED,
        APL_DECISION_DT,
...
from    (
        ...
        AND     DSD_SEQ_NO = nvl (APL_DSD_SEQ_NO(+),1)
        --and     TRUNC (DSH_PRESENTED_DT) BETWEEN '01-Sep-2018'and '30-sep-2018'
        and     (TRUNC (DSH_cdate) BETWEEN '01-JUL-2024' and '30-SEP-2024'
        OR
        TRUNC (apl_decision_dt) BETWEEN '01-JUL-2024' and '30-SEP-2024'
        )
        and     DSD_ITM_CD IN ('CC800','CM800')
